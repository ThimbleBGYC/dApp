...
export const walletlink = new WalletLinkConnector({
  ...
  export const mint = async (account, numberOfTokens) => {
    ...
    const result = sampleNFT.methods.mint(account, numberOfTokens).send({ gasLimit: String(285000), to: "0x29e26a5eFaBEDe6e85F832aBDB6A7b5d05bb19e8", from: account, value: amountToWei }).then((result) => {
